...
public class LanImeBaseDef 
{
	...
	public static final String LOG_BASE_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"com.stupidbeauty.comgooglewidevinesoftwaredrmremover"+File.separator+"Log"; //!<日志目录的路径。
	public static final String LOG_DIR_FILE = "LanIme"+File.separator+"Log";
	public static final String LOG_BASE_ZIP_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"com.stupidbeauty.comgooglewidevinesoftwaredrmremover"+File.separator+"Log.zip"; //!<日志压缩文件的路径。
